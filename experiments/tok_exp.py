...
if __name__ == '__main__':
    ...
    print(f"Estimated time: {(end-start)*825*1024/290/60/60: .2f} hours on The Pile (825GB)")  # 38.9 hours
    ...
    print("3. batch encoding, 2 processes")

    start = time.time()
    with open(txt_path, 'rb') as f:
        all_ids = tok.encode_batch(f, num_processes=2)
    end = time.time()
    print(f"Took: {end-start: .2f} seconds on 290MB")
    print(f"{290/(end-start):.2f} MB per second")
    print(f"Estimated time: {(end-start)*825*1024/290/60/60: .2f} hours on The Pile (825GB)")  # 21.7 hours
    ...
    print(f"Took: {end-start: .2f} seconds on 290MB")
    print(f"{290/(end-start):.2f} MB per second")
    print(f"Estimated time: {(end-start)*825*1024/290/60/60: .2f} hours on The Pile (825GB)")  # 93.3 hours
